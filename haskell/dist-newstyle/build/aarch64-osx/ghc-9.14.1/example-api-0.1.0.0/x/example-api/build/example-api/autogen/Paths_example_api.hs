...
-- at runtime using the environment variable example_api_bindir.
...
-- environment variable example_api_libdir.
...
-- using the environment variable example_api_dynlibdir.
...
-- runtime using the environment variable example_api_datadir.
...
-- variable example_api_libexedir.
...
-- using the environment variable example_api_sysconfdir.
...
bindir     = "/Users/sonnen/.cabal/bin"
libdir     = "/Users/sonnen/.cabal/lib/aarch64-osx-ghc-9.14.1-bcbf/example-api-0.1.0.0-inplace-example-api"
dynlibdir  = "/Users/sonnen/.cabal/lib/aarch64-osx-ghc-9.14.1-bcbf"
datadir    = "/Users/sonnen/.cabal/share/aarch64-osx-ghc-9.14.1-bcbf/example-api-0.1.0.0"
libexecdir = "/Users/sonnen/.cabal/libexec/aarch64-osx-ghc-9.14.1-bcbf/example-api-0.1.0.0"
sysconfdir = "/Users/sonnen/.cabal/etc"

getBinDir     = catchIO (getEnv "example_api_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "example_api_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "example_api_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "example_api_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "example_api_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "example_api_sysconfdir") (\_ -> return sysconfdir)
